...
GUIDialog::GUIDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_lblPassword = new wxStaticText( this, wxID_ANY, wxT("密码:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_lblLen = new wxStaticText( this, wxID_ANY, wxT("输出长度:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_lblLen->Wrap( -1 );
	...
	m_cboxAutoClose = new wxCheckBox( this, wxID_ANY, wxT("自动关闭"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_lblPassType = new wxStaticText( this, wxID_ANY, wxT("密码类型:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_lblPassType->Wrap( -1 );
	bSizer41->Add( m_lblPassType, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	wxString m_cboxPassTypeChoices[] = { wxT("标准(22符号)"), wxT("纯数字") };
	...
	m_lblVersion = new wxStaticText( this, wxID_ANY, wxT("密码版本:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_lblVersion->Wrap( -1 );
	...
	m_cboxShowPass = new wxCheckBox( this, wxID_ANY, wxT("显示密码"), wxDefaultPosition, wxDefaultSize, 0 );
