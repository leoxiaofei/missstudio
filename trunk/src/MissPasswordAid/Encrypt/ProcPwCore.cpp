...
ProcPwCore::ProcPwCore(unsigned char nLen, short nEdition, PWTYPE eType)
: m_uLen(nLen)
, m_nEdition(nEdition)
, m_eType(eType)
{
...
void ProcPwCore::SetOutLen(unsigned char uLen)
{
    m_uLen = uLen;
}
