...
GUIDialog::GUIDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	// Connect Events
	m_edtPassword->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( GUIDialog::OnPasswordTextEnter ), NULL, this );
...
{
	// Disconnect Events
	m_edtPassword->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( GUIDialog::OnPasswordTextEnter ), NULL, this );
